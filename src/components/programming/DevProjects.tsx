...
export const programmingImages = import.meta.glob(
...
export const programmingProjects: Project[] = [
  ...
  },
  {
    ...
    image: '/src/components/programming/img/IHA-AnaSayfa(ziyaretci).png',
