...
export const programmingProjects: Project[] = [
  ...
  {
    id: '12',
    title: 'Enerji Santrali Üretim Tahminleme',
    description: "Bu proje, Polat Enerji Santralleri'nin 2024 yılı 2-8 Eylül haftası toplam enerji üretim tahminini içermektedir.",
    image: programmingImages['./img/Polat_Enerji_Tum_Tahmin_Serileri.png'].default,
    technologies: [
      { name: 'XGBoost', slug: 'XGBoost' },
      { name: 'Arima', slug: 'Arima' },
      { name: 'Zaman Serisi', slug: 'Zaman_Serisi' },
      { name: 'Python', slug: 'Python' },
      { name: 'Veri Analizi', slug: 'Veri_Analizi' },
      { name: 'Exponential Smoothing', slug: 'Exponential_Smoothing' },
      { name: 'Polat Enerji', slug: 'Polat_Enerji' },
      { name: 'Rüzgar Enerjisi', slug: 'Ruzgar_Enerjisi' },
      { name: 'Enerji Üretimi', slug: 'Enerji_Uretimi' },
      { name: 'Enerji Analizi', slug: 'Enerji_Analizi' },
      { name: 'Enerji Tahminleme', slug: 'Enerji_Tahminleme' },
    ],
    link: '',
    github: 'https://github.com/ksyusuf/Polat_Enerji_Tum_Tahmin_Serileri',
    prod: '',
    medium: '',
    date: '2024-09-02',
  },
  {
    id: '13',
    title: 'RedValid',
    description: "RiseIn HackStellar hackathonu için geliştirilmiş, Web3 tabanlı bir validasyon sistemidir. Videoların orjinal hallerini gerçek kişiler/kurumlar ile eşleştirilmiş bir hash olarak blokzincire kaydedip bu ağın değiştirilemez ve şeffaflık avantajını kullanarak tekel bir doğrulama altyapısı sunmaktadır.",
    image: programmingImages['./img/RedValid_Blockchain_VideoDogrulama.png'].default,
    technologies: [
      { name: 'Python', slug: 'Python' },
      { name: 'Rise In', slug: 'Rise_In' },
      { name: 'Stellar', slug: 'Stellar' },
      ...
      { name: 'Tailwind CSS', slug: 'Tailwind_CSS' },
      { name: 'PostgreSQL', slug: 'PostgreSQL' },
      { name: 'Video Doğrulama', slug: 'Video_Dogrulama' },
      { name: 'Hackathon', slug: 'Hackathon' },
      { name: 'Render', slug: 'Render' },
      { name: 'Netlify', slug: 'Netlify' },
    ],
    link: 'https://www.linkedin.com/feed/update/urn:li:activity:7407298576269316096/',
    github: 'https://github.com/ksyusuf/RedValid',
    prod: 'https://redvalid.netlify.app/',
    medium: '',
    date: '2025-11-30',
  }
]
